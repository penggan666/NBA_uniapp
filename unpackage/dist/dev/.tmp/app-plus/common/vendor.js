  ...
  if (!!this.events[type]) {
    this.events[type].forEach(function (listener) {
      try {
        ...
        console.error(e, " at js_sdk\\u-charts\\components\\u-charts\\u-charts.js:3364");
      }
    });
  }
};
...
Charts.prototype.zoom = function () {
  ...
  if (this.opts.enableScroll !== true) {
    console.log('请启用滚动条后使用！', " at js_sdk\\u-charts\\components\\u-charts\\u-charts.js:3520");
    return;
  }
  //当前屏幕中间点
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var BASE = 'http://192.168.103.69:8082';var _default =
{
